...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.03851] Large Language Models in Sport Science & Medicine: Opportunities, Risks and Considerations](http://arxiv.org/abs/2305.03851) #transformer`
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.03807] Evading Watermark based Detection of AI-Generated Content](http://arxiv.org/abs/2305.03807) #generative`
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.04007] Weighted Point Cloud Normal Estimation](http://arxiv.org/abs/2305.04007) #noise`
...
* Paper URL: [http://arxiv.org/abs/2305.04203](http://arxiv.org/abs/2305.04203)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.04203] Unlocking the Power of Open Set : A New Perspective for Open-set Noisy Label Learning](http://arxiv.org/abs/2305.04203) #noise`
* Summary: <p>Learning from noisy data has attracted much attention, where most methods
...
* Copy Paste: `<input type="checkbox">[[2305.04076] SANTA: Separate Strategies for Inaccurate and Incomplete Annotation Noise in Distantly-Supervised Named Entity Recognition](http://arxiv.org/abs/2305.04076) #noise`
...
* Copy Paste: `<input type="checkbox">[[2305.03920] Automated Spatio-Temporal Graph Contrastive Learning](http://arxiv.org/abs/2305.03920) #noise`
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.04152] Bayesian Over-the-Air FedAvg via Channel Driven Stochastic Gradient Langevin Dynamics](http://arxiv.org/abs/2305.04152) #noise`
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.03980] Towards Prompt-robust Face Privacy Protection via Adversarial Decoupling Augmentation Framework](http://arxiv.org/abs/2305.03980) #diffusion`
...
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.04063] Exploring One-shot Semi-supervised Federated Learning with A Pre-trained Diffusion Model](http://arxiv.org/abs/2305.04063) #diffusion`
...
* Copy Paste: `<input type="checkbox">[[2305.04151] Context-Aware Chart Element Detection](http://arxiv.org/abs/2305.04151) #object detection`
...
### Title: YOLOCS: Object Detection based on Dense Channel Compression for Feature Spatial Solidification. (arXiv:2305.04170v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.04170](http://arxiv.org/abs/2305.04170)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.04170] YOLOCS: Object Detection based on Dense Channel Compression for Feature Spatial Solidification](http://arxiv.org/abs/2305.04170) #object detection`
* Summary: <p>In this study, we examine the associations between channel features and
